...
export const OfflineHandler: React.FC<{
  ...
  return <div className="relative">
      {/* Offline Status Bar */}
      {!isOnline && <Alert className="mb-4 border-orange-200 bg-orange-50">
          <WifiOff className="h-4 w-4" />
          <AlertDescription className="flex items-center justify-between">
            <span>
              You're working offline. Changes will be saved locally and synced when you reconnect.
            </span>
            <Button variant="outline" size="sm" onClick={retrySync} className="ml-4">
      ...
      {pendingActions.length > 0 && <Alert className="mb-4 border-blue-200 bg-blue-50">
